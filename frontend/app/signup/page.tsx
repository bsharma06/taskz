      ...
      <div className="max-w-xs w-full space-y-8">
        <div>
          ...
          <p className="mt-4 text-center text-xs text-muted-foreground">
            Create an account and verify your details to start managing your day today tasks.
          </p>
          ...
          <div className="rounded-md shadow-sm space-y-4">
            <div>
              ...
              <input
                ...
                autoComplete="name"
                required
                className="appearance-none relative block w-full px-3 py-2 border border-input bg-background placeholder-muted-foreground text-foreground rounded-md focus:outline-none focus:ring-0 focus:ring-ring focus:border-ring focus:z-10 sm:text-sm"
